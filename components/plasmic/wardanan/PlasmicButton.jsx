...
import sty from "./PlasmicButton.module.css"; // plasmic-import: dr59HzdIu2I8GO/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: t0ZhyR3Q1GULpD/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: GmUASqrUBLQeud/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__beRno)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___8TvCx)}
                role={"img"}
              />
            ),

...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 7sjzLtUSb4FTm/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: ERt6eDxcGZvAOd/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: t0ZhyR3Q1GULpD/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__oqSgZ)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__qpRbA)}
                role={"img"}
              />
            ),
